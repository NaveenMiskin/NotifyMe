This App is an Notifying app that when we sent message form mobile app it will display on webpage and when we reply to that message that will be displayed in the android app
